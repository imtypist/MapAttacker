...
public class XposedPlugin implements IXposedHookLoadPackage {
    ...
    static {
        ...
        pkgs.add("com.autonavi.minimap");
        pkgs.add("com.baidu.BaiduMap");
        pkgs.add("com.tecent.map");
    }
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam loadPackageParam) throws Throwable {
        ...
        if (!pkgs.contains(loadPackageParam.packageName)){
            return;
        }

        Log.i(TAG, "加载应用程式：" + loadPackageParam.packageName);

        findMethodIsFromMockProvider();

        findMethodGetInt(loadPackageParam);
     ...
     * 判断是否开启允许ADB模拟定位功能
     */
    private static void findMethodIsFromMockProvider(){
     ...
     */
    private static void findMethodGetInt(XC_LoadPackage.LoadPackageParam loadPackageParam){
     ...
     * 处理一堆杂项钩。
     */
    private void initOther(final XC_LoadPackage.LoadPackageParam lpparam) {
        //  检查调试是否开启时始终返回false
     ...
     */
    private void initFile(final XC_LoadPackage.LoadPackageParam lpparam) {
        /**
         挂钩File文件的一个版本。
     ...
     */
    private void initActivityManager(final XC_LoadPackage.LoadPackageParam lpparam) {
        /**
    ...
    private void initProcessBuilder(final XC_LoadPackage.LoadPackageParam lpparam) {
     ...
     * 挂钩设备设置。
     */
    private void initSettingsGlobal(final XC_LoadPackage.LoadPackageParam lpparam) {
